...
if 'model' not in st.session_state:
    try:
        ...
        st.error(f"Critical Error during model initialization: {str(e)}")
...
def get_video_properties(video_path):
    ...
    try:
        ...
        st.error(f"Error reading video properties for {video_path}: {str(e)}")
        return 0, 0, 30
    ...
    try:
        ...
        while cap.isOpened() and frame_count < total_frames:
            ...
            try:
                ...
                st.error(f"Error processing frame {frame_count} of {video_path}: {str(e)}")
                continue
...
def process_videos(video_paths: List[str], max_workers: int) -> Dict[str, Dict]:
    ...
    try:
        ...
        st.error(f"Error in process_videos: {str(e)}")
        return {}
...
def main():
    ...
    try:
        ...
        st.sidebar.error(f"Error displaying system resources: {str(e)}")
    ...
    with col1:
        ...
        try:
            ...
            st.error(f"Error listing approved videos: {str(e)}")
    ...
    with col2:
        ...
        try:
            ...
            st.error(f"Error listing rejected videos: {str(e)}")
